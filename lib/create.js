...
var create = module.exports = function() {
    var questions = [
        ...
        },
        {
            type: 'list',
            name: 'usage',
            message: 'Which web library do you choose?',
            choices: [
                "npm - https://npmjs.com",
                "nbm - http://web.51.nb"
            ]
...
create.makeProject = function(options) {
    ...
    create
        ...
        .then(function() {
            return create.install(target, options.usage);
        })
        .then(function () {
            console.log('');
...
create.install = function(target, usage) {
    return new Promise(function(resolve){
        spawn(usage.split(' - ')[0], ['install'], { cwd: target, stdio: 'inherit'});
        resolve();
    });
};
